...
import { eventChatRouter } from "@/server/api/routers/event-chat";
import { eventLogisticsRouter } from "@/server/api/routers/event-logistics";
...
export const appRouter = createTRPCRouter({
  ...
  eventLogistics: eventLogisticsRouter,
  event: eventRouter,
  follow: followRouter,
